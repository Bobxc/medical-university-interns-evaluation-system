<template>
  <div class="container" v-loading="loading">
    ...
    <el-card class="detail-list-content-card">
      <div class="box box1" @click="$router.push('/teacher/training')">
        <div class="box-left">
      ...
      <div class="box box7" @click="toComment">
        <div class="box-left">
...
<script>
import { getStudentInfo } from "api/teacher-api/studentPracticeTraining";

<template>
  <div class="evaluation-teaching-detail-container" v-loading="loading">
    ...
    <div class="main-card" v-if="PjListData.length !== 0">
      <!-- 学生评教 -->
      <el-card
          ...
          <el-col :span="20">
            ...
            >
              ...
              <el-col :span="10" class="num-col"
                >{{ PjMainData.F_totalNumb }}分</el-col
              >
...
import { getCheckInfo } from "api/teacher-api/studentPracticeTraining";
import { getPjStudentData } from "api/teacher-api/studentPracticeTraining";
export default {

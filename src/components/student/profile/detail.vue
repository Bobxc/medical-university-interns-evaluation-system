    ...
    <el-card class="detail-title-card">
      ...
      <div class="title-right">
        <div class="edit-btn" @click="toEdit">
          <img src="@/assets/image/笔.png" alt="" style="margin-right: 5px" />
          <span>编辑</span>
        </div>
      </div>
    </el-card>
...
<script>
import { getArea, getUserInfo, getZzmm } from "api/student-api/profile";
export default {
  name: "ProfileDetail",
  data() {
    return {
    ...
    userInfo() {
      ...
      getUserInfo(params).then((res) => {
        ...
        if (res.code == 100) {
          ...
          this.zzmmName =
            this.userInfomation.zzmm !== null
              ? this.zzmmListData.find(

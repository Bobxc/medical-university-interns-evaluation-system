      ...
      <el-card v-for="(item, index) in dataList" :key="index">
        ...
        <div class="body-container">
          ...
          <el-row
            ...
            align="middle"
            v-show="item.iptRowShow"
          >
            <el-col class="ipt-col" :span="8">
              <el-input
                v-model="item.iptVal"
                placeholder="请输入疾病名称"
              ></el-input>
            </el-col>
            <el-col class="ipt-btn" :span="2" @click.native="addBtn(item)">
              确定
            </el-col>
          </el-row>
          <el-row class="add-row" type="flex" align="middle">
            <el-col :span="3" @click.native="item.iptRowShow = true">
              <span>添加操作</span>
      ...
      <div class="dialog-content">
        ...
        <el-row type="flex" justify="end">
          <el-col
            ...
            >取消</el-col
          >
          <el-col class="remark-save" :span="4" @click.native="remarkSave">保存</el-col>
        </el-row>
      </div>
    </el-dialog>
    <!-- 重置弹框 -->
    ...
    >
      <div class="reset-container-dialog">
        ...
        <div class="reset-footer-dialog">
          ...
          <div class="reset-reset" @click="resetDialogVisible = false">
            重置
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
                      ...
                      return {
                        ...
                        child: dep.child.map((dep_) => {
                          return {
                            ...
                            name: dep_.name,
                            remark: "",
                            F_Observation: dep_.F_Observation,
                            F_FollowGuide: dep_.F_FollowGuide,
                            F_IndependentCompletion:
                              dep_.F_IndependentCompletion,
                          };
                        }),
                      };
                    });
    ...
    saveForm() {
      ...
      console.log("提交数据", this.dataList);
      let idArr = [];
      let valueArr = [];
